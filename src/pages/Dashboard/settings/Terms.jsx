...
const Terms = () => {
    ...
    // Use the Redux query hook with 'terms-and-condition' type
    const { data: contentData, isLoading, refetch } = useGetPublicContentQuery("terms-and-condition");
    ...
    useEffect(() => {
        if (contentData) {
            setContent(contentData.content || "No terms and conditions content available. Please edit to add content.");
        }
    }, [contentData]);
    ...
    const config = {
        readonly: false,
        placeholder: "Start typing terms and conditions content...",
        ...
        return (
            <div>
                <div className="flex items-center my-10 text-2xl">
                    ...
                    <h2 className="text-[#00A430] font-semibold">Terms and Conditions</h2>
                </div>
                ...
                {isEditing ? (
                    <>
                        <div className="space-y-4">
                            <label className="block font-semibold">Terms and Conditions Content:</label>
