        ...
        },
        {
            ...
            render: (text, record) => (
                <div className="flex items-center gap-3">
                    <img
                        src={record.originalData?.profile ? (record.originalData.profile.startsWith("http") ? record.originalData.profile : `${import.meta.env.VITE_BASE_URL}${record.originalData.profile}`) : "https://i.pravatar.cc/40"}
                        alt="avatar"
