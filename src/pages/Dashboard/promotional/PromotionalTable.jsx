...
const PromotionalTable = () => {
    ...
    const columns = [
        {
            ...
            render: (text) => (
                <div className="flex items-center gap-3">
                    <img src="https://i.pravatar.cc/40" alt="company-logo" className="w-10 h-10 rounded-full" />
        ...
        },
        {
            title: "Status",
            key: "status",
            render: (_, record) => <span className={`px-4 py-1 rounded-lg text-sm font-medium ${statusColor[record.status]}`}>{record.status}</span>,
        },
        {
            title: "Action",
            key: "action",
    ...
    return (
        <div className="p-4">
            ...
            >
                <Table className="rounded-xl overflow-hidden shadow-md" dataSource={promoData} columns={columns} rowKey="key" pagination={false} />
            </ConfigProvider>
